...
konfiguracija.ucitajKonfiguraciju().then(pokreniServer).catch((err) => {
    console.error(err);
...
function pokreniServer(){
    const port = konfiguracija.dajKonf()["rest.port"];
...
function restTMDB() {
    let restTMDB = new RestTMDB(konfiguracija.dajKonf()["tmdb.apikey.v3"]);
